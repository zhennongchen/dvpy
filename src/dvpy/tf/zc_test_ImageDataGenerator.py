...
class zc_test_ImageDataGenerator(object):
    ...
    def flow(
        ...
        return dv.tf.zc_test_NumpyArrayIterator(
            X,
            y,
            self,
    ...
    def random_transform(self, x, y,raw_x=None,raw_y=None):
        translation,rotation,scale,transform_matrix = dv.generate_random_transform(
        ...
        if raw_x is None:
            ...
            raw_x = dv.apply_affine_transform(
                raw_x,
                transform_matrix[:-1, :],
            ...
            # For y, mask data, fill mode constant, cval = 0
            raw_y = dv.apply_affine_transform(
                raw_y,
                transform_matrix[:-1, :],
            ...
            return x,y,raw_x,raw_y,translation,rotation,scale,transform_matrix
