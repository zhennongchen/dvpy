...
class NumpyArrayIterator_predict(IteratorBase):
    def __init__(
        self,
        X,
        y,
        ...
        super(NumpyArrayIterator_predict, self).__init__(X.shape[0], batch_size, slice_num, shuffle, seed)
    ...
    def next(self):
        ...
        with self.lock:
            ...
            print('in the iterator: array, current_index, current_batch_size: ',index_array,current_index,current_batch_size)
